...
var CoreLoginSiteHelpPage = /** @class */ (function () {
    ...
    CoreLoginSiteHelpPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-core-login-site-help',template:/*ion-inline-start:"/Users/ardiandeari/moodlemobiledirectory/src/core/login/pages/site-help/site-help.html"*/'<ion-header>\n    <ion-navbar>\n        <ion-title>{{ \'core.login.help\' | translate }}</ion-title>\n\n        <ion-buttons end>\n            <button ion-button icon-only (click)="closeHelp()" [attr.aria-label]="\'core.close\' | translate">\n                <ion-icon name="close"></ion-icon>\n            </button>\n        </ion-buttons>\n    </ion-navbar>\n</ion-header>\n<ion-content padding>\n    <core-format-text [text]="\'core.login.helpmelogin\' | translate"></core-format-text>\n</ion-content>\n'/*ion-inline-end:"/Users/ardiandeari/moodlemobiledirectory/src/core/login/pages/site-help/site-help.html"*/,
        }),
